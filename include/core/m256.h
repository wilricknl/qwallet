...
union m256i
{
    ...
    void setRandomValue()
    {
        _rdrand64_step((unsigned long long int*)&m256i_u64[0]);
        _rdrand64_step((unsigned long long int*)&m256i_u64[1]);
        _rdrand64_step((unsigned long long int*)&m256i_u64[2]);
        _rdrand64_step((unsigned long long int*)&m256i_u64[3]);
    }
